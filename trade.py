    ...
    while (True):
        ...
        try:
            ...
            if (order['status'] == 'FILLED'):
                ...
                print("Sell Order executed, you have earned (你赚了) USDT: ", quantity_to_sell*100 )

                fd.write(f"Sell Order executed, you have earned (你赚了) USDT:  {quantity_to_sell*100} \n")

                total_profit += quantity_to_sell*100

                print("Total profit总利润： ",  total_profit)

                fd.write(f"Total profit总利润：{total_profit}\n"  )
        ...
        try:
            ...
            if (float(btc_price['price']) <= (price_to_buy -400)):
                ...
                print("Stop Loss Triggered at ", btc_price['price'], "亏损 You lost ",quantity_to_sell* 400)

                total_profit -= quantity_to_sell*(price_to_buy -price_to_sell)

                print("Total profit: ",  total_profit)

                fd.write(f"Stop Loss Triggered at {btc_price['price'] } 本轮交易，  本轮亏损 You lost {quantity_to_sell* 400}\n")
